...
type CimiteriModel struct {
	...
	Planimetria         string         `json:"planimetria"             gorm:"column:planimetria;type:varchar(255);not null"`
	Settori             []SettoriModel `                               gorm:"foreignKey:CimiteroID;constraint:OnDelete:CASCADE;"`
}
