...
type DefuntiModel struct {
	...
	DataNascita       string               `json:"dataNascita"       gorm:"column:data_nascita;type:varchar(30);not null"`
	DataOraMorte      string               `json:"dataOraMorte"      gorm:"column:data_ora_morte;type:varchar(30);not null"`
	LuogoNascita      string               `json:"luogoNascita"      gorm:"column:luogo_nascita;type:varchar(30);not null"`
